...
public interface UnitWordRepository extends JpaRepository<UnitWord, Long> {
    ...
    @Query("SELECT new com.jiji.dto.UnitWordDTO(uw.id, uw.unitId, u.name, u.textbookId, t.name, t.grade, t.publisher, uw.wordId, w.wordText, w.americanPhonetic, w.britishPhonetic, w.pronUs, w.pronUk, uw.createdAt) " +
           "FROM UnitWord uw " +
